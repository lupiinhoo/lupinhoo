...
local function createButton(text, parent, position, size)
	...
	btn.Text = text
	btn.BackgroundColor3 = Color3.fromRGB(20, 20, 20)        -- preto bem escuro
	btn.TextColor3 = Color3.fromRGB(230, 230, 230)           -- quase branco
	btn.Size = size
	...
	btn.MouseEnter:Connect(function()
		btn.BackgroundColor3 = Color3.fromRGB(40, 40, 40)      -- cinza escuro no hover
	end)
...
frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)             -- fundo preto puro
frame.BorderSizePixel = 0
frame.Parent = screenGui
frame.Active = true
frame.Draggable = true
frame.ClipsDescendants = true
frame.BackgroundTransparency = 0 -- fundo totalmente visível
...
header.BackgroundColor3 = Color3.fromRGB(30, 30, 30)          -- cinza escuro no header
...
headerText.TextColor3 = Color3.fromRGB(220, 220, 220)          -- texto quase branco
...
closeBtn.BackgroundColor3 = Color3.fromRGB(100, 0, 0)          -- vermelho escuro
...
nameBox.BackgroundColor3 = Color3.fromRGB(15, 15, 15)          -- fundo preto do TextBox
nameBox.TextColor3 = Color3.fromRGB(230, 230, 230)             -- texto claro
...
nameBox.PlaceholderColor3 = Color3.fromRGB(100, 100, 100)      -- placeholder cinza
